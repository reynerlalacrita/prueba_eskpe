...
import 'package:prueba_eskpe/recursos/screens/busqueda_screen.dart'; // Ajusta la ruta si es necesario
import 'package:prueba_eskpe/recursos/screens/usuario_screen.dart';   // Ajusta la ruta si es necesario
...
CarouselSlider(
  ...
  return BottomNavigationBar(
    ...
    currentIndex: 0, // Aquí podrías poner una variable de estado si quieres que el icono se resalte
    onTap: (index) {
      // Lógica de navegación al tocar los iconos
      switch (index) {
        case 0:
          // Ya estás en Home
          break;
        case 1:
          Navigator.push(context, MaterialPageRoute(builder: (context) => const BusquedaScreen()));
          break;
        case 2:
          // Si es admin, va al panel, si no, al perfil de usuario
          if (rol == 'admin') {
